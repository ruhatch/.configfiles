...
--
myWorkspaces = ["1: <fn=1>\xf269</fn> ","2: <fn=1>\xf120</fn> ","3: <fn=1>\xf121</fn> "] ++ map (\x -> show x ++ ": <fn=1>\xf128</fn> ") [4..9] ++ ["10: <fn=1>\xf1bc</fn> "]
...
myManageHook = composeAll [
    className =? "Firefox"          --> doShift "1: <fn=1>\xf269</fn> ", 
    className =? "Spotify"          --> doShift "10: <fn=1>\xf1bc</fn> ",
